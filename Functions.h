...
void sys_uncert_weightfactor(TH1D *hist_up, TH1D *hist_down, double variable, double nomial_totweight, double nomial_weight, double weight_up, double weight_down ){

  double w_up = nomial_totweight*weight_up/nomial_weight;
  double w_down = nomial_totweight*weight_down/nomial_weight;
  hist_up->Fill(variable,w_up);
  hist_down->Fill(variable,w_down);
}
